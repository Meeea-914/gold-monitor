...
from monitor.database.events import (BlockchainStateEvent, SilicoinEvent, ConnectionsEvent,
...
class RpcCollector(Collector):
    ...
    @staticmethod
    async def create(root_path: Path, net_config: Dict, event_queue: Queue[SilicoinEvent],
        ...
        if len(self.tasks) < 1:
            raise ConnectionError(
                "Failed to connect to any RPC endpoints, Check if your Silicoin services are running")
